...
namespace cw10
{
    ...
    {
        private readonly s18705Context db;
        public StudentsController()
        {
            db = new s18705Context();
        }
        ...
        {
            var res = from enroll in db.Enrollment join studies in db.Studies on enroll.IdStudy equals studies.IdStudy where enroll.Semester == promotions.Semester && studies.Name == promotions.Studies select enroll;
